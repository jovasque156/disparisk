# We based on https://github.com/UCSB-NLP-Chang/Fairness-Reprogramming/blob/master/CelebA/dataset.py
# To download dataset, please follow the instructions here: https://github.com/UCSB-NLP-Chang/Fairness-Reprogramming/blob/master/CelebA/README.md
# and save the files in data/ folder.
import os
import numpy as np
import torch
import h5py
...
class CelebAFast(Dataset):
    ...
    # This function supposly provides the target label and the sensitive attribute
